"""
Django settings for grampanchayatProject project.
...
SECRET_KEY = 'dy*h+qcmya60&%##18ojwd+#1*0zi*azr!(3ackg3gowe(8ev2'
...
ROOT_URLCONF = 'grampanchayatProject.urls'
